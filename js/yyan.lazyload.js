(function($, window, document) {
	...
	$.Lazyload = $.Class.extend({
		...
		_cacheWidth: function(el) {
			if(el._yyan_lazy_width) {
				return el._yyan_lazy_width;
			}
			return el._yyan_lazy_width = el.offsetWidth;
		},
		_cacheHeight: function(el) {
			if(el._yyan_lazy_height) {
				return el._yyan_lazy_height;
			}
			return el._yyan_lazy_height = el.offsetHeight;
		},
