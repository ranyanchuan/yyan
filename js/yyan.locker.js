...
(function($, doc) {
	...
	styleHolder.innerHTML += "<style>.yyan-locker-holder{overflow:hidden;position:relative;padding:0px;}.yyan-locker-holder canvas{width:100%;height:100%;}</style>";
	...
	var Locker = $.Locker = $.Class.extend({
		...
		initEvent: function(canvas, cxt, holder) {
			...
			self._endHandler = function(e) {
				 ...
				 * 在 yyan 没有完整的公共事件模块前，此版本中 locker 实例暂通过 options.callback 处理
				 */
